...
part of 'recruiter_application_api_service.dart';
...
class _RecruiterApplicationApiService
  ...
  Future<RecruiterApplicationResponseModel> getApplications(
    ...
    final _options = _setStreamType<RecruiterApplicationResponseModel>(
    ...
    late RecruiterApplicationResponseModel _value;
    try {
      _value = RecruiterApplicationResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
