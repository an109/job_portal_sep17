...
class _JobScreensApiService implements JobScreensApiService {
  ...
  @override
  Future<HttpResponse<AllJobsResponse>> getOpportunities() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<AllJobsResponse>>(
    ...
    late AllJobsResponse _value;
    try {
      _value = AllJobsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<JobDetailsResponseModel>> getJobDetails(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<JobDetailsResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'jobdetails/${job_id}',
  ...
  Future<HttpResponse<JobApplyModel>> applyForJob(
    ...
    _data.addAll(params);
    final _options = _setStreamType<HttpResponse<JobApplyModel>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late JobApplyModel _value;
    try {
      _value = JobApplyModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
