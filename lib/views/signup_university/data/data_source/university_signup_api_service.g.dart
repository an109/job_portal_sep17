...
part of 'university_signup_api_service.dart';
...
class _UniversitySignupApiService implements UniversitySignupApiService {
  _UniversitySignupApiService(this._dio, {this.baseUrl, this.errorLogger}) {
